...
const TabletDetails = () => {
  ...
  const [selectedImage, setSelectedImage] = useState(tablet.thumbnail);

  const smallImages = tablet.images;
      ...
      <div className="container-fluid wrapper">
        <div className="row">
          ...
          <div className="col-5 image-details">
            <h2>{tablet.title}</h2>
            <p className="name">
              <b className="tag">Description:</b> {tablet.description}
            </p>
            <p className="category">
              <b className="category-name">Category:</b> {tablet.category}
            </p>
            <p>
              <b className="Price">${tablet.price}</b>{" "}
              <span className="discount">{tablet.discountPercentage}% off</span>
            </p>
            <p className="name">
              <b className="tag">Brand:</b> {tablet.brand}
            </p>
            <p>
            ...
            <p className="name">
              ...
              {`Width:${tablet.dimensions.width} x Height:${tablet.dimensions.height} x Depth:${tablet.dimensions.depth}`}
            </p>
            <p className="name">
              <b className="tag">Stock Available:</b> {tablet.stock}
            </p>
            <p className="name">
              <b className="tag">Warranty:</b> {tablet.warrantyInformation}
            </p>
            <p className="name">
              <b className="tag">Delivery:</b> {tablet.shippingInformation}
            </p>
            <p className="name">
              <b className="tag">Stock:</b> {tablet.availabilityStatus}
            </p>

            <h2>Reviews</h2>
            <div>
              {tablet.reviews && tablet.reviews.length > 0 ? (
                tablet.reviews.map((review, index) => (
